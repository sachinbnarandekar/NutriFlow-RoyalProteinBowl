...
# Load dependency CSVs generated by Sakshi and Reeta
customers_df = pd.read_csv("../data/raw/customers.csv")
staff_df = pd.read_csv("../data/raw/staff.csv")
coupons_df = pd.read_csv("../data/raw/coupons.csv")
locations_df = pd.read_csv("../data/raw/locations.csv")
item_master_df = pd.read_csv("../data/raw/item_master.csv")
